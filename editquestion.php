<?php 
if(!isset($_GET['wc_q']) & isset($_GET['wc_t'])){
                    ...
                    <div class="bg-white tm-block h-100">
                        ...
                        <table class="table table-hover table-striped mt-3">
                            <tbody>
                                ...
                                <tr>
                                    <td><a href="add_answer.php?wc_t=<?php echo $topic;?>&wc_q=<?php echo $quiz;?>&wc_que=<?php echo $_GET['wc_qu'];?>">Add Answer</a></td>
                                ...
                                <?php } ?>
                                <tr>
                                    <td><a href="editquiz.php?wc_t=<?php echo $topic;?>&wc_q=<?php echo $quiz;?>">View Quiz</a></td>
